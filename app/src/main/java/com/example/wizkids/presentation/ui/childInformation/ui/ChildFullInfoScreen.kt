...
import com.example.wizkids.presentation.ui.childInformation.constant.ChildInformationLogicConstant.CHILD_INFO_CARD_INITIAL_FULL_NAME_INDEX
import com.example.wizkids.presentation.ui.childInformation.constant.ChildInformationLogicConstant.CHILD_INFO_CARD_INITIAL_PARTS_INDEX_FIRST_NAME
import com.example.wizkids.presentation.ui.childInformation.constant.ChildInformationLogicConstant.CHILD_INFO_CARD_INITIAL_PARTS_INDEX_LAST_NAME
import com.example.wizkids.presentation.ui.childInformation.constant.ChildInformationLogicConstant.CHILD_INFO_CARD_INITIAL_PARTS_INDEX_TAKE_INDEX
...
class ChildFullInfoScreen {
    ...
    fun ChildFullInfo(
        ...
        val childFirstName = remember { mutableStateOf(parts[USER_CARD_INITIAL_PARTS_INDEX_FIRST_NAME]) }
        val childLastName = remember { mutableStateOf(parts[USER_CARD_INITIAL_PARTS_INDEX_LAST_NAME]) }
        ChildInformationCardBackGround().InformationCardbackGround {
            ...
            InputInformationCard().AddInformationCard(stringResource(R.string.basic_information), textFont) {
                ChildInformationCardValueGrayAndWhiteText().InformationCardValueGrayAndWhiteText(textFont, stringResource(R.string.full_name),child.name)
                ChildInformationCardValueGrayAndWhiteText().InformationCardValueGrayAndWhiteText(textFont, stringResource(R.string.birth_date),child.dateOfBirth)
                ChildInformationCardValueGrayAndWhiteText().InformationCardValueGrayAndWhiteText(textFont, stringResource(R.string.age_label),AgeHelper().getAgeFromDate(child.dateOfBirth))
            }
            InputInformationCard().AddInformationCard(stringResource(R.string.additional_info_label), textFont) {
                textFont.WhiteText(child.additionalInfo)
            }
            InputInformationCard().AddInformationCard(stringResource(R.string.finance_info_label), textFont) {
                ChildInformationCardValueGrayAndWhiteText().InformationCardValueGrayAndWhiteText(textFont, "${
                    stringResource(R.string.balance)
                } :",child.currentBalance.toString())
                ChildInformationCardValueGrayAndWhiteText().InformationCardValueGrayAndWhiteText(textFont,
                    stringResource(R.string.visit_price_label),child.visitPrice.toString())
            }
            InputInformationCard().AddInformationCard(stringResource(R.string.documents_label), textFont) {
            ...
            InputInformationCard().AddInformationCard(stringResource(R.string.development_stages_label), textFont) {
            ...
            InputInformationCard().AddInformationCard(stringResource(R.string.recent_visits_label), textFont) {
            ...
            ButtonView().ButtonVisibleColumn(
                buttonNames =mapOf(
                    stringResource(R.string.edit_child_activity_title) to{
                        IntentHelper().intentStartById(KEY_ACTIVITY_CHILD_ADD_INFO,context,child.id)
                    },

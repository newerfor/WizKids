...
import com.example.core_ui.ui.CreateANewVisitWindow
import com.example.core_ui.ui.GetFullDate
import com.example.core_ui.ui.TextFont
import com.example.core_ui.ui.getDateToday
import com.example.core_ui.ui.getDaysInMonth
import com.example.core_ui.ui.getFirstDayOfMonth
import com.example.core_ui.ui.isWeekend
...
fun DayInMonth(
    ...
    val daysInMonth = getDaysInMonth(monthNumber.value, yearNumber.value)
    val firstDayOfMonth = getFirstDayOfMonth(monthNumber.value, yearNumber.value)
...
fun DayCard(
    ...
    val fullDate = GetFullDate(dayNumber, monthNumber.value, yearNumber.value)
...
fun DayColorState(currentDate: String, dateInfo: List<DomainVisitModel>): Color {
    return if (isWeekend(currentDate)) {
        grayColor
    } else {
